...
| **Em-dash as sentence-separator** | Em-dash standing in for a colon, semicolon, or full stop                                                                          | Banned in shipped Alex ACT prose. Use a colon (for "here's why"), a semicolon (for a paired thought), parentheses (for a side note), or split the sentence.       |
...
- After: `[behaviour] fetch: 3s timeout replaces indefinite hang on unreachable release`
