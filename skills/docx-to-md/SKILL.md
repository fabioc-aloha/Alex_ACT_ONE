...
```bash
# Basic conversion
node skills/docx-to-md/scripts/docx-to-md.cjs report.docx

# With frontmatter and heading normalization
node skills/docx-to-md/scripts/docx-to-md.cjs spec.docx --add-frontmatter --fix-headings

# Strip review comments
node skills/docx-to-md/scripts/docx-to-md.cjs reviewed.docx --strip-comments

# Custom output path
node skills/docx-to-md/scripts/docx-to-md.cjs input.docx output/document.md

# Debug mode (keeps raw pandoc output)
node skills/docx-to-md/scripts/docx-to-md.cjs input.docx --debug

# Full cleanup pipeline
node skills/docx-to-md/scripts/docx-to-md.cjs spec.docx --add-frontmatter --fix-headings --strip-comments --clean-tables
```
...
node skills/docx-to-md/scripts/docx-to-md.cjs stakeholder-spec.docx \
...
Get-ChildItem *.docx | ForEach-Object {
  node skills/docx-to-md/scripts/docx-to-md.cjs $_.FullName --add-frontmatter --fix-headings
}
```
...
`skills/docx-to-md/scripts/docx-to-md.cjs`
