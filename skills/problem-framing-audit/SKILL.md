...
| User explicitly invokes `/alex-act-one problem-framing-audit` or asks "what am I missing?" | **Always audit** |
...
- [CRITICAL-THINKING-FAILURE-MODES](https://github.com/fabioc-aloha/Alex_ACT_Core/blob/main/skills/problem-framing-audit/SKILL.md) — the master failure mode and step-back protocol
