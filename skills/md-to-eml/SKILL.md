...
```bash
# Basic conversion
node skills/md-to-eml/scripts/md-to-eml.cjs newsletter.md

# With test recipient override (safe preview)
node skills/md-to-eml/scripts/md-to-eml.cjs newsletter.md --test --test-to me@example.com

# Embed images as CID attachments
node skills/md-to-eml/scripts/md-to-eml.cjs update.md --inline-images

# Debug mode (saves intermediate HTML)
node skills/md-to-eml/scripts/md-to-eml.cjs update.md --debug
```
...
`skills/md-to-eml/scripts/md-to-eml.cjs`
