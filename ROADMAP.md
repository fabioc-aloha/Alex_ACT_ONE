...
- One user-level payload can serve Copilot CLI, VS Code, Microsoft Scout, and
  the GitHub Copilot app, but each app must resolve the intended copy and version
