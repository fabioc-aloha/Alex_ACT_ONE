...
4. If the selected model requires a credential, verify the named host environment
	variable or approved secret-storage route without printing its value; otherwise
	route to setup.
